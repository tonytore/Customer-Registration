...
const Category = () => {
  return (
    <div className='text-white  py-[100px] '>
     ...
     <Link className='flex gap-2 items-center bg-lime-600 hover:bg-lime-600/90 focus:ring-4 focus:ring-lime-600/50 px-5 rounded-md' href="/customers/category/new"><FaPlus/>
